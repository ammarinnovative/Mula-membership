    ...
    <Stack>
      <Flex gap={"20px"}>
        <Stack flex={"3"}>
          ...
          <Stack spacing={"4"}>
            <Input type={Text} border={"1px solid #000"} placeholder="Crypto Explained: Security Action" _placeholder={{ color:"#000"}}/>
            <Select  placeholder='Crypto' border={"1px solid #000"} _placeholder={{color:"#000",fontWeight:"bold"}}>
          ...
          <Stack spacing={"4"}>
            <Textarea type={Text} mt={"10px"} border={"1px solid #000"}  placeholder="Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur." _placeholder={{color:"#000"}}></Textarea>
            <Input type={Text} border={"1px solid #000"} placeholder="$25.00" _placeholder={{ color:"#000"}}/>
          </Stack>
          ...
          <Stack direction="column,row" gap={"10px"}>
            <Box>
              <Image  src={Upload_your_video_1}></Image>
              <Stack gap={"15px"} direction={"column,row"} mt={"5px"}>
            ...
            <Box>
              <Image src={Upload_your_video_2}></Image>
              <Stack gap={"15px"} direction={"column,row"} mt={"5px"}>
                <Link to="/"><Text fontSize={"18px"}fontWeight={"400"}color="#000"><EditIcon fontSize={"20px"} color={"#000"}/> Edit</Text></Link>
                <Link to="/"><Text fontSize={"18px"}fontWeight={"400"}color="#000"><DeleteIcon fontSize={"20px"} color={"#000"}/> Delete</Text></Link>
              </Stack>
          ...
          <Stack> 
              ...
              <label htmlFor='file'>
                <Stack 
                  ...
                  borderRadius={"10px"}
                  cursor={"pointer"} spacing="2"alignItems={"center"} width={"30%"}>
