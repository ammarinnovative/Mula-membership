    ...
    return (
        <Box backgroundImage={ColorShade} display={"flex"} flexDirection={"column"} justifyContent={"center"} alignItems={"center"} className="boxMode" width={"100%"} height={"100vh"} backgroundSize={"cover"}>
            <Box display={"flex"} flexDirection={"column"} alignItems={"center"} >
                ...
                <Text textTransform={"uppercase"} fontFamily={'Poppins700'} fontSize={"68px"} fontWeight={"900"} color={"white"}>Welcome</Text>
                ...
                <FormControl color={"white"} display={"flex"} flexDirection={"column"} alignItems={"center"} justifyContent={"center"} isRequired>
                    <Input _placeholder={{ color: 'white' }} color={"white"} placeholder='First Name' type={"email"} width={"md"} marginBottom={"10px"} />
                    <Input _placeholder={{ color: 'white' }} color={"white"} placeholder='Last Name' type={"email"} width={"md"} marginBottom={"10px"} />
                    ...
                    <Box display={"flex"} marginTop={"10px"} color={"white"} width={"full"} justifyContent={"space-between"}>
                        <Checkbox colorScheme={"blue"} checkBox>Remember password?</Checkbox>
                    </Box>
                    <Button marginTop={"20px"} width={"full"} colorScheme={"blue"}>Login</Button>
                </FormControl>
            </Box>
        </Box>
    )
